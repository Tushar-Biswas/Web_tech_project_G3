    ...
    <script>
        function showinventory(str) 
        {
            ...
            else
            {
                ...
                xhttp.open("GET", "getinventory.php?q="+str, true);
                xhttp.send();
            }
        }
...
<b><label for="fname">Book name/ Author/ Code/ ID :</label></b>
<input type="text" id="fname" name="fname" onkeyup="showinventory(this.value)">
<br>
<br>
<br>
<!-- <p>Suggestions: <span id="txtHint"></span></p> -->
<div id="txtHint"><b>Book inventory will be listed here...</b></div>
